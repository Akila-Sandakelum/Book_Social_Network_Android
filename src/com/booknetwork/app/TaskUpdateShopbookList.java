...
class TaskUpdateShopbookList
  extends AsyncTask<String, Void, Integer>
{
  private final String URL = "http://books.knnect.com/bookshop/booklist/add";
  private int output;
  ...
  protected Integer doInBackground(String... paramVarArgs)
  {
    for (;;)
    {
      try
      {
        ...
        localJsonObject.addProperty("quantity", paramVarArgs[2]);
        DefaultHttpClient localDefaultHttpClient = new DefaultHttpClient();
        HttpPost localHttpPost = new HttpPost("http://books.knnect.com/bookshop/booklist/add");
 ...
 * Qualified Name:     com.booknetwork.app.TaskUpdateShopbookList

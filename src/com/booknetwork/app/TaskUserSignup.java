...
class TaskUserSignup
  extends AsyncTask<String, Void, Integer>
{
  final String URL = "http://books.knnect.com/user/signup";
  int output;
  String response = "";
  ...
  protected Integer doInBackground(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        HttpPost localHttpPost = new HttpPost("http://books.knnect.com/user/signup");
 ...
 * Qualified Name:     com.booknetwork.app.TaskUserSignup
